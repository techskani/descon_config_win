...
const CircuitChartList: React.FC = () => {
  ...
  // console.log(`desconData=${Object.keys(desconData)}`); // バックエンドから取得したデータ
  // console.log(`desconData=${desconData["ホーム分電盤40回路B"]["temperature"][1]}`); // バックエンドから取得したデータ
  ...
  /* 障害の切り分けのためトラッキング・データのCSVファイル保存を止める - kotani (2026/03/06)
